...
| [live cross-check](2026-09-11-live-crosscheck-design.md) | design | A replay exits **98.8% by stop** where the desk exits **13%**, and the mean R figures agree - so the number everyone looks at matched while the mechanics did not. Compares structure rather than performance, and labels the result rather than refusing it. The exit work waits on this |
