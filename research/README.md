...
| [barriers.md](barriers.md) | **measured** - the two-level trade as a triple-barrier problem; the setup exists on 20.3% of calls and the far barrier is reached **42.9%** of the time against a 1.0v stop, which is positive before costs - and corrects an inference that said it was unreachable |
