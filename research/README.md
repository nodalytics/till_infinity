...
| [localising.md](localising.md) | **measured** - shifting the 15m bar grid by a minute moves the located origin a median 0.34v (2.60v for impulse origins), about twice as stable as random rather than stable; plus three discrepancies between the origin-localization specification and the code |
