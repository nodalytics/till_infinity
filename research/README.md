...
| [barriers.md](barriers.md) | **measured** - the two-level trade as a triple-barrier problem; the setup exists on 20.3% of calls, and the corridor is 3.3v median against a 1.9v median hold, so the far barrier is the right frame and the wrong target |
