...
| [localising.md](localising.md) | **measured** - the origin survives its own falsification test: shifting the 15m bar grid by a minute moves it a median 0.23v, 2.8x steadier than a matched random book and about a seventh of the band it already carries. Includes the corrected harness bug and three discrepancies between the origin-localization specification and the code |
